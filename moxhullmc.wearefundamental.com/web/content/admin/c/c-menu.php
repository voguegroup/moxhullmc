	...
	<div class="container">		
		...
		<div id="page-container">
			...
			<div id="page-pad-title">
				<h1>Customers</h1>
				<p>Options and systems to manage data supplied by customers.</p>
			</div>
				
		<ul id="option-menu">
			<li onmouseover="this.style.backgroundColor='#f4f4f4';" onmouseout="this.style.backgroundColor='#ffffff';"><a href="orders-view.php"><img src="../images/icons/orders_48.gif" alt="" name="icon-home" width="48" height="48" hspace="15" vspace="0" border="0" align="left" id="icon-home" /><strong><br />Orders</strong></a></li>
		</ul>
			</div>
