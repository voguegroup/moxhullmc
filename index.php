		...
		<div class="container">
			<form action="#" class="search_form advsearch_hide clearfix">
            	<div class="row field_select">
                    <label class="label_title">Make:</label>
                ...
                <div class="row field_select">
                    ...
                    <select class="select_styled" name="car_model">
                        ...
                        <option value="4" selected>£4000-£4999</option>
                ...
                <div class="adv_search_hidden clearfix">
					<div class="row field_select">
						...
						<select class="select_styled" name="car_mileage">
							...
							<option value="2">Up to 25,000</option>
							<option value="3">Up to 50,000</option>
							<option value="4">Up to 75,000</option>
            ...
            <div class="special_offers">
                ...
                <div id="special_offers">
                    ...
                    <div class="special_item">
                        ...
                        <div class="special_text">
                        	<h3><a href="offers-details.html">VW Polo</a></h3>
                            <div class="info_row"><span>FIRST REG:</span> NOV 2010</div>
                            <div class="info_row"><span>ENGINE:</span> 1.2</div>
                            <div class="info_row"><span>MILEAGE</span> 54,000</div>
